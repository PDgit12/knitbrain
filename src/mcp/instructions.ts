...
6. Looking for code? knitbrain_search_code FIRST (ranked chunks + related files), then knitbrain_read ONLY the hits — selection beats compression. Big file? knitbrain_read (not raw Read). Big output to keep? knitbrain_optimize. Exact original back? knitbrain_retrieve with the ⟨recall:hash⟩.
